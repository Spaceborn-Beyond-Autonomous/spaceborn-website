      ...
      <StarsBackground className="flex min-h-screen items-center justify-center">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4 py-20">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="relative mb-6">
              ...
              <div className="flex items-center justify-center gap-4 mb-2">
                <span
                  className="font-black tracking-tighter 
                            ...
                            lg:text-[clamp(4.5rem,10vw,8rem)]
                            bg-linear-to-r from-white via-gray-300 to-gray-500 bg-clip-text text-transparent"
                >
                  SPACE
                </span>
                <span
              ...
              <div className="flex items-center justify-center gap-4 my-4">
                ...
                <span
                  ...
                  text-sm 
                  text-white/50 
                  tracking-[0.15em] sm:tracking-[0.25em] lg:tracking-[0.3em]
            ...
            tracking-wide mb-8 max-w-2xl mx-auto 
            leading-relaxed"
            >
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Button
                ...
                bg-white text-black hover:bg-gray-200 rounded-full px-6 py-4 sm:px-8 sm:py-6
                font-semibold tracking-wide group transition-all
                "
              >
              ...
              <Button
                ...
                className="
                border-white/30 
                text-white hover:bg-white/10 hover:border-white/50 rounded-full 
